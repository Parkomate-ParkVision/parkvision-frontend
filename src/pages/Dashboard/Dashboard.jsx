import { Box, Card, CardHeader,Container, Unstable_Grid2 as Grid } from '@mui/material';
    ...
    >
      ...
      <Grid
                ...
                {Array.from(Array(15)).map((_, index) => (
                  <Grid item xs={2} sm={4} md={4} key={index}>
                    {(index % 4 === 0) && (<Card sx={{
                      ...
                      onMouseLeave={(e) => {
                        e.currentTarget.style.backgroundColor = 'primary.main';
                      }
                      }
                    >
          ...
          <Grid
            ...
            lg={5.5}
          >
            <OverviewPeakHours seriesData = {[
            {
              data: [5, 8, 10, 12, 15, 18, 20, 18, 15, 12, 10, 8, 7, 6, 5, 4],
            },
          ]}/>
          </Grid>
          <Grid
