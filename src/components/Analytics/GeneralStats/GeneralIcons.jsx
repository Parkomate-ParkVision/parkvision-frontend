...
const MaxCustomersIcon = ()=>{
  ...
  >
    <circle cx="20" cy="20" r="20" fill="#5cb80f" />
    <GroupRoundedIcon style={{color:"white"}}/>
  </svg>
...
export{
    EarningsIcon, EntriesIcon, ExitsIcon, FirstTimeEntriesIcon, MaxCustomersIcon
}